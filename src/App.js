...
const getWeatherData = async()=>{
    let response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${search}&appid=c011d88c9b4e1214219ea0dcd94748cb`);
...
useEffect(()=>{
  ...
  return (
    <div className="App">
      <h1 className="heading">Your Local Weather at a Glance</h1>
  ...
  <p className='foot'>Developed By, Mohaideen Arsath</p>
</div>
    </div>
  );
}
